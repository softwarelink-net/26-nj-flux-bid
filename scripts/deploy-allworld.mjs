...
/**
 * Upload dist/ to:
 *   1) R2 26-nj-flux-bid-assets
 *   2) R2 allworld-sites/26-nj-flux-bid/
 * 仅写入本站点对象键，不删除 allworld-sites 下其他站点前缀。
 */
...
const siteId = process.argv[2] || '26-nj-flux-bid'
const projectBucket = '26-nj-flux-bid-assets'
